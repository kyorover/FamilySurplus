...
export const SPRITE_CONFIG: Record<string, SpriteDefinition> = {
  'PL-01': {
    ...
    frameWidth: 152, frameHeight: 235, frameCount: 5, frameSpacingX: 0, offsetX:0, offsetY: 88,
  ...
  'PL-03': {
    ...
    frameWidth: 152, frameHeight: 179, frameCount: 5, frameSpacingX: 0, offsetX: 0, offsetY: 96,
    baseScale: 1.4, isAnimated: false, maxQuantity: 1,
  },
  'EF-01': { // じょうろ
  ...
  'IT-01': { // レトロな街灯
    ...
    frameWidth: 84, frameHeight: 100, frameCount: 2, frameSpacingX: 0, offsetX: 2, offsetY: 44,
    baseScale: 1.0, isAnimated: true, animationSpeed: 3000,
  },
  'IT-02': { // 木のベンチ
    sourceId: 'item1', originalWidth: 342, originalHeight: 729, startX: 6, startY: 380,
    frameWidth: 76, frameHeight: 83, frameCount: 1, frameSpacingX: 0, offsetX: 0, offsetY: 54,
  ...
  'IT-05': { // 花(黄)
    ...
    frameWidth: 68, frameHeight: 43, frameCount: 1, frameSpacingX: 0, offsetX: -3, offsetY: 60,
    baseScale: 1.0, isAnimated: false,
  },
  'IT-06': { // 花(紫)
    sourceId: 'item2', originalWidth: 68, originalHeight: 369, startX: 0, startY: 136,
    frameWidth: 68, frameHeight: 40, frameCount: 1, frameSpacingX: 0, offsetX: -3, offsetY: 60,
    baseScale: 1.0, isAnimated: false,
  },
  'IT-07': { // 花(赤)
  ...
  'IT-10': { // 観葉植物
    ...
    frameWidth: 68, frameHeight: 80, frameCount: 1, frameSpacingX: 0, offsetX: -3, offsetY: 60,
    baseScale: 1.0, isAnimated: false,
  },
  'CR-01': { // 猫
  ...
  'CR-03': { // 狸
    ...
    frameWidth: 82, frameHeight: 73, frameCount: 6, frameSpacingX: 0, offsetX: 0, offsetY: 56,
  ...
  'CR-04': { // 狐
    ...
    frameWidth: 82, frameHeight: 72, frameCount: 7, frameSpacingX: 0, offsetX: 0, offsetY: 56,
  ...
  'CR-05': { // パンダ
    ...
    frameWidth: 82, frameHeight: 66, frameCount: 8, frameSpacingX: 0, offsetX: 0, offsetY: 56,
  ...
  'CR-06': { // 馬
    ...
    frameWidth: 80, frameHeight: 68, frameCount: 4, frameSpacingX: 0, offsetX: 0, offsetY: 60,
    baseScale: 1.0, isAnimated: true, animationSpeed: 350, maxQuantity: 1,
  },
  'CR-07': { // ブルドック
    sourceId: 'item5', originalWidth: 648, originalHeight: 385, startX: 0, startY: 260,
    frameWidth: 80, frameHeight: 56, frameCount: 5, frameSpacingX: 0, offsetX: 0, offsetY: 50,
    baseScale: 0.8, isAnimated: true, animationSpeed: 350, maxQuantity: 1,
  },
  'CR-200': { // 子供(男の子)
    sourceId: 'chara2', originalWidth: 459, originalHeight: 396, startX: 0, startY: 3,
    frameWidth: 153, frameHeight: 129, frameCount: 3, frameSpacingX: 0, offsetX: 0, offsetY: 48,
  ...
  'CR-201': { // 子供(女の子)
    ...
    frameWidth: 80, frameHeight: 64, frameCount: 4, frameSpacingX: 0, offsetX: 0, offsetY: 48,
    baseScale: 0.7, isAnimated: true, animationSpeed: 500, maxQuantity: 1,
  },
  'CR-202': { // パパ
    sourceId: 'chara2', originalWidth: 459, originalHeight: 396, startX: 0, startY: 133,
    frameWidth: 153, frameHeight: 132, frameCount: 3, frameSpacingX: 0, offsetX: 0, offsetY: 48,
    baseScale: 0.7, isAnimated: true, animationSpeed: 600, maxQuantity: 1,
  },
  'CR-203': { // ママ
    sourceId: 'chara2', originalWidth: 459, originalHeight: 396, startX: 0, startY: 266,
    frameWidth: 153, frameHeight: 132, frameCount: 3, frameSpacingX: 0, offsetX: 0, offsetY: 48,
    baseScale: 0.7, isAnimated: true, animationSpeed: 600, maxQuantity: 1,
  },
  'CR-204': { // 社会人(男)
    sourceId: 'chara1', originalWidth: 459, originalHeight: 799, startX: 0, startY: 137,
    frameWidth: 153, frameHeight: 133, frameCount: 2, frameSpacingX: 0, offsetX: 0, offsetY: 46,
    baseScale: 0.7, isAnimated: true, animationSpeed: 2000, maxQuantity: 1,
  },
  'CR-205': { // 社会人(女)
    sourceId: 'chara1', originalWidth: 459, originalHeight: 799, startX: 0, startY: 3,
    frameWidth: 153, frameHeight: 130, frameCount: 2, frameSpacingX: 0, offsetX: 0, offsetY: 46,
    baseScale: 0.7, isAnimated: true, animationSpeed: 2000, maxQuantity: 1,
  },
  'CR-206': { // 大学生(男)
    sourceId: 'chara1', originalWidth: 459, originalHeight: 799, startX: 0, startY: 410,
    frameWidth: 153, frameHeight: 133, frameCount: 3, frameSpacingX: 0, offsetX: 0, offsetY: 46,
    baseScale: 0.7, isAnimated: true, animationSpeed: 2000, maxQuantity: 1,
  },
  'CR-207': { // 大学生(女)
    sourceId: 'chara1', originalWidth: 459, originalHeight: 799, startX: 0, startY: 270,
    frameWidth: 153, frameHeight: 133, frameCount: 3, frameSpacingX: 0, offsetX: 0, offsetY: 46,
    baseScale: 0.7, isAnimated: true, animationSpeed: 2000, maxQuantity: 1,
  },
  'CR-208': { // おじいちゃん
    sourceId: 'chara1', originalWidth: 459, originalHeight: 799, startX: 0, startY: 533,
    frameWidth: 153, frameHeight: 133, frameCount: 2, frameSpacingX: 0, offsetX: 0, offsetY: 46,
    baseScale: 0.7, isAnimated: true, animationSpeed: 2000, maxQuantity: 1,
  },
  'CR-209': { // おばあちゃん
    sourceId: 'chara1', originalWidth: 459, originalHeight: 799, startX: 0, startY: 666,
    frameWidth: 153, frameHeight: 133, frameCount: 2, frameSpacingX: 0, offsetX: 0, offsetY: 46,
    baseScale: 0.7, isAnimated: true, animationSpeed: 2000, maxQuantity: 1,
  },
  'WP-01': {
