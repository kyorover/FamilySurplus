...
export const ALL_GARDEN_ITEMS: GardenItemMaster[] = [
  ...
  { id: 'CR-200', name: '子供(男の子)', type: 'ornament', cost: 100, isShoppable: true },
  { id: 'CR-201', name: '子供(女の子)', type: 'ornament', cost: 100, isShoppable: true },
  { id: 'CR-202', name: 'ママ', type: 'ornament', cost: 100, isShoppable: true },
  { id: 'CR-203', name: 'パパ', type: 'ornament', cost: 100, isShoppable: true },
  { id: 'CR-204', name: '社会人(男)', type: 'ornament', cost: 100, isShoppable: true },
  { id: 'CR-205', name: '社会人(女)', type: 'ornament', cost: 100, isShoppable: true },
  { id: 'CR-206', name: '大学生(男)', type: 'ornament', cost: 100, isShoppable: true },
  { id: 'CR-207', name: '大学生(女)', type: 'ornament', cost: 100, isShoppable: true },
  { id: 'CR-208', name: 'おじいちゃん', type: 'ornament', cost: 100, isShoppable: true },
  { id: 'CR-209', name: 'おばあちゃん', type: 'ornament', cost: 100, isShoppable: true },
