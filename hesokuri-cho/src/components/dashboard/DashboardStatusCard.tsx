  ...
  return (
    <TouchableOpacity activeOpacity={0.9} onPress={onPressCard} style={styles.card}>
      <View style={styles.header}>
        <View>
          <Text style={styles.subTitle}>総へそくり残高</Text>
          <Text style={styles.totalAmount}>¥{gardenPoints.toLocaleString()}</Text>
        </View>
      ...
      <View style={styles.body}>
        <View style={styles.progressHeader}>
          <Text style={styles.subTitle}>今月のへそくり進捗</Text>
          <Text style={[styles.monthAmount, { color: progressColor }]}>
...
const styles = StyleSheet.create({
  ...
  totalAmount: { fontSize: 28, fontWeight: 'bold', color: '#1C1C1E' },
