  ...
  return (
    <View style={styles.isoControlsOverlay} pointerEvents="box-none">
      <View style={styles.isoDiamond}>
        <TouchableOpacity style={[styles.isoBtn, styles.btnTop]} onPress={() => onMove(0, -1)}><Text style={styles.isoArrow}>↗</Text></TouchableOpacity>
        <TouchableOpacity style={[styles.isoBtn, styles.btnLeft]} onPress={() => onMove(-1, 0)}><Text style={styles.isoArrow}>↖</Text></TouchableOpacity>
        <TouchableOpacity style={[styles.isoBtn, styles.btnRight]} onPress={() => onMove(1, 0)}><Text style={styles.isoArrow}>↘</Text></TouchableOpacity>
        <TouchableOpacity style={[styles.isoBtn, styles.btnBottom]} onPress={() => onMove(0, 1)}><Text style={styles.isoArrow}>↙</Text></TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  isoBtn: { position: 'absolute', width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(255, 255, 255, 0.95)', justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 3, elevation: 4, borderWidth: 1, borderColor: '#E0E0E0' },
  btnTop: { top: 0, left: 38 }, btnLeft: { top: 38, left: 0 }, btnRight: { top: 38, left: 76 }, btnBottom: { top: 76, left: 38 },
