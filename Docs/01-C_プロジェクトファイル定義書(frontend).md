...
| app.json / package.json / tsconfig.json | Expoの設定およびNode.js/TypeScriptの構成。**【重要】app.json には expo-tracking-transparency プラグインと、審査に必須の権限許可メッセージが設定済みである。** |
